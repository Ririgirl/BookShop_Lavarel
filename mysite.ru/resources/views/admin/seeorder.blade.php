...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-6"><h1 class="mt-4">Подробнее о заказе</h1></div>
        </div>
        ...
        <table class="table">
          ...
          <tbody>
            @FOREACH ($orders_lists as $order_list)
            <tr>
              <td scope="col">{{ $loop->iteration }} {{-- Starts with 1 --}}</td>
              <td scope="col">{{ $order_list->name_book }}</td>
              <td scope="col">{{ $order_list->kol_vo }} шт.</td>
            </tr>
            @endFOREACH
          </tbody>
        </table>
