    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
	        ...
	        <div class="container">
	         <form action = "{{ action('AdminController@saveauth') }}" method = "post" name='data'>
	            {{ csrf_field() }}
	            <input type="hidden" name='_method' value='post'/>
	            <div class="row">
	                <div class="col-md-3"><p><strong>Фамилия </strong></p></div>
	                <div class="col-md-9"><input type="text" class="form-control" name = 'fname'></div>
                  ...
                  <div class="col-md-9"><input type="text" class="form-control" name = 'oname'></div>
	            	</div><br/>
